...
NSString * const CloudCartJS_HTTPS_1 = @"https://cart.yintai.com/Scripts/h5.js";
NSString * const CloudCartJS_HTTPS_2 = @"https://r.ytrss.com/mobile/js/lib/require.js";
NSString * const CloudCartJS_HTTPS_3 = @"https://m.yintai.com/Scripts/h5.js";

NSString * const DiTuiJS_HTTPS_1 = @"https://ditui.yintai.com/js/jquery.js";
NSString * const DiTuiCSS_HTTPS_2 = @"https://ditui.yintai.com/js/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min1.css";
NSString * const DiTuiJS_HTTPS_3 = @"https://ditui.yintai.com/js/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.js";
NSString * const DiTuiCSS_HTTPS_4 = @"https://ditui.yintai.com/js/jquery.mobile-1.4.5/jquery.mobile-1.4.5.min.css";
...
+ (instancetype)shared
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        instance.localArr = @[ CloudCartJS_HTTPS_1,CloudCartJS_HTTPS_2,CloudCartJS_HTTPS_3 ,DiTuiJS_HTTPS_1,DiTuiCSS_HTTPS_2,DiTuiJS_HTTPS_3,DiTuiCSS_HTTPS_4];
...
- (void)requestToGetUpgradeInfo
{
    ...
    if (appArr.count) {
        [[YTOauthManager shared] requestWithUrl:IPTypeH5Resource type:PathTypeH5ResourceList params:@[appArr] success:^(id data) {
            ...
            H5ResourceManagerLog(@"获取更新列表失败", @"", error);
        }];
    }
}
...
- (BOOL)checkJsonDataWithPath:(NSString *)path andJsonFilePath :(NSString *)jsonPath
{
    ...
    if (jsonData) {
        ...
        if (json && !error) {
            NSDictionary *contentHash = [json customForKey:@"contentHash"];
            if (contentHash && [contentHash isKindOfClass:[NSDictionary class]]) {
                for (NSString *key in contentHash.allKeys) {
                    if (![self checkHashWithPath:[path stringByAppendingPathComponent:key] andHashString:[contentHash customForKey:key]]) {
                        return NO;
                    }
                }
                return YES;

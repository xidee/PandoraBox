...
extern NSString * const CloudCartJS_HTTPS_1;
extern NSString * const CloudCartJS_HTTPS_2;
extern NSString * const CloudCartJS_HTTPS_3;
//地推JS CSS

 
extern NSString * const DiTuiJS_HTTPS_1;
extern NSString * const DiTuiCSS_HTTPS_2;
extern NSString * const DiTuiJS_HTTPS_3;
extern NSString * const DiTuiCSS_HTTPS_4;
